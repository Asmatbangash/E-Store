...
export default function Hero() {
  return (
    <section className="flex items-center justify-center my-15 max-sm:my-5">
      <div className="hero-content flex flex-col-reverse lg:flex-row-reverse items-center gap-12 px-6 lg:px-12 w-full">
